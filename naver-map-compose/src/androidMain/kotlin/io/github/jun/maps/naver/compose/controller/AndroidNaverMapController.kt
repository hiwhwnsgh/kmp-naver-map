package io.github.jun.maps.naver.compose.controller

import com.naver.maps.map.CameraAnimation
import com.naver.maps.map.CameraUpdate
import com.naver.maps.map.NaverMap
import io.github.jun.maps.naver.compose.internal.dpToPx
...
class AndroidNaverMapController(
    ...
    override fun moveCamera(
        ...
        animation: io.github.jun.maps.naver.compose.model.CameraAnimation,
        durationMs: Int,
        onFinish: (() -> Unit)?
    ) {
...
private fun io.github.jun.maps.naver.compose.model.CameraAnimation.toNaver(): CameraAnimation =
    when (this) {
        io.github.jun.maps.naver.compose.model.CameraAnimation.None -> CameraAnimation.None
        io.github.jun.maps.naver.compose.model.CameraAnimation.Linear -> CameraAnimation.Linear
        io.github.jun.maps.naver.compose.model.CameraAnimation.Easing -> CameraAnimation.Easing
        io.github.jun.maps.naver.compose.model.CameraAnimation.Fly -> CameraAnimation.Fly
    }
